const PROJECTS = [
  {
    ...
    tier: "full",
    awards: [
      "[trophy]Best VR Game · Silver — NYX Awards 2023",
      "[trophy]First PSVR2 game shipped from the Middle East"
    ],
    links: [
    ...
    description: {
      ...
      notable: "[trophy]First PSVR2 title shipped from the Middle East · [trophy]Silver, Best VR Game, NYX Game Awards 2023, an international game awards program · [star]Shipped and live on PlayStation Store, Steam, Meta Store, and PICO VR globally and in China",
      problem: "Shipping a single codebase across six VR platforms simultaneously — each with different input systems, SDKs, certification requirements, and hardware constraints — while keeping the game performant and functionally identical across all of them.",
      solution: "Maintained a platform-agnostic core architecture and isolated platform-specific behaviour behind targeted patches. For PSVR2, the most demanding platform, this meant writing PlayStation engine-level code directly, navigating Sony's certops process, and solving console-specific constraints like save system size limits and input mapping — none of which had prior art to reference."
    },
    youtube: ["4OaNlcSKZKY"]
  },
  {
    ...
    tier: "full",
    awards: [
      "[trophy]Best PC Shooter · Silver — NYX Awards 2021 (as Shadow Dreams: The Last Thought of Hope)"
    ],
    links: [
    ...
    description: {
      ...
      contributions: "Worked as lead developer alongside the studio director, responsible for the majority of the codebase.\n\nBuilt all core gameplay systems including a full combat system with multiple weapons, payload types, and an FX pooling system for performance. Designed and implemented all enemy types and bosses, including multi-phase boss fights with distinct attack patterns.\n\nBuilt the parkour movement system with wall running and mantling, and developed an aim assist system.\n\nBuilt the thoughts pickup system forming the core roguelite loop, and contributed to a procedural content generation system to vary level layouts across runs.\n\nHandled all UI work, all console and controller integrations including PS5 haptics, and a full achievements system.",
      notable: "[trophy]Silver, Best PC Shooter, NYX Game Awards 2021, won under the original title Shadow Dreams: The Last Thought of Hope · [star]Coming soon to PC, PS5, Xbox, and Switch 2"
    },
    youtube: ["8KgG1VwAwMM"]
  },
  {
    ...
    description: {
      ...
      contributions: "Worked as lead developer on a three person team alongside the studio director and a game and level designer, responsible for the majority of the codebase.\n\nBuilt a full combat system with multiple weapons, payload types, and an FX pooling system for performance. Designed and implemented all enemy types and bosses, including multi-phase boss fights with distinct attack patterns.\n\nDeveloped an aim assist system and a core roguelite pickup loop. Contributed to a procedural content generation system to vary level layouts across runs.\n\nHandled all UI work, all console and controller integrations including PS5 haptics, and a full achievements system.",
      notable: "[star]Coming soon to PC, PS5, Xbox, and Switch 2 · [star]Wishlistable now on Steam"
    },
    youtube: ["XubvHykJX7A"]
  },
  {
    ...
    description: {
      ...
      notable: "[star]Shipped and live on Steam"
    },
  ...
  },
  {
    ...
    tier: "full",
    awards: [
      "[star]Made for Discovery Channel — showcased across multiple locations"
    ],
    links: [],
    description: {
      ...
      notable: "[star]Built under contract for Discovery Channel, showcased across UAE and international locations · [star]Full physical immersion via custom robotic chair, haptics, fans, water spray, and EM lock integration",
      problem: "The physical simulator chair and peripheral rig had no plugin, no SDK, and no Unreal Engine support. It needed to receive live motion data from the game in real time over a raw serial connection — with no documentation, no abstraction layer, and no prior art to reference.",
      solution: "Built a fully custom hardware integration from scratch using Windows API calls for serial communication, a custom binary protocol with CRC16 checksums for data integrity, and a modular UE4 ActorComponent architecture that mapped live actor rotations to chair axis values. Extended the same system to drive a second hardware board controlling fans, vibration motors, water spray, and an electromagnetic lock via a runtime JSON device mapping file."
    },
  ...
  },
  {
    ...
    tier: "full",
    awards: [
      "[star]Pre-launch QA across all 10 VR experiences at one of the region's largest gaming venues"
    ],
    links: [
    ...
    description: {
      ...
      notable: "[star]Pre-launch QA and consulting across all 10 VR experiences at one of the region's largest gaming venues · [star]Trailer production for all featured park titles and Robocom VR's Transformers VR · [star]Engaged through Robocom VR and Khosouf Studio, 2022"
    },
  ...
  },
  {
    ...
    tier: "full",
    awards: [
      "[star]Official VR experience for the Jeddah Central development project, KSA"
    ],
    links: [],
    description: {
      ...
      notable: "[star]Official VR experience for the Jeddah Central development project, one of Saudi Arabia's largest urban development initiatives · [star]Showcased to high-profile KSA government authorities"
    },
  ...
  },
  {
    ...
    tier: "full",
    awards: [
      "[star]Showcased at Al-Hosn Festival and multiple local festivals",
      "[star]Demonstrated to Sheikh Khaled Bin Zayed to showcase Abu Dhabi Gaming growth"
    ],
    links: [],
    description: {
      ...
      contributions: "Sole developer on the project, responsible for the entire codebase and all systems.\n\nThe centrepiece of the technical work was the interactive constellation system, built in collaboration with an official UAE astronomy authority to ensure the star positions, constellation data, and cultural information were accurate. Players physically connect stars in VR space to form constellations, which then trigger educational content.\n\nAlso built the camel ride playable cutscene, the target shooting system with scoring, and the online leaderboard that persists scores across players globally.",
      notable: "[star]Showcased at Al-Hosn Festival and multiple local cultural festivals across Abu Dhabi · [star]Demonstrated to Sheikh Khaled Bin Zayed at a private event as a showcase of Abu Dhabi Gaming's growth as a government-backed initiative supporting the UAE games industry"
    },
  ...
  },
  {
    ...
    tier: "full",
    awards: [
      "[star]Built with full flight sim chair and haptic apparatus integration"
    ],
    links: [],
    description: {
      ...
      notable: "[star]Built with full flight simulator chair and ForceSeat haptic platform integration · [star]Private client installation"
    },
  ...
  },
  {
    ...
    description: {
      ...
      contributions: "Lead developer on the project alongside the studio director, responsible for the entire codebase.\n\nBuilt all environment systems including dynamic weather, time of day, and rain intensity controls, along with full environment switching logic across beach, moon, and forest settings.\n\nBuilt the dragon progression system tied to daily session tracking, and the guided breathing exercise system using timed animations and UI.\n\nBuilt the Zen platform ascension mechanic and handled all UI work across the experience.",
      notable: "[star]Shipped and live on Steam"
    },
    youtube: ["MqBdLEGtP3E"]
  },
  {
    ...
    tier: "full",
    awards: [
      "[trophy]Global Game Jam UAE 2024 — Winner"
    ],
    links: [
    ...
    description: {
      ...
      notable: "[trophy]Winner, Global Game Jam UAE 2024"
    },
    youtube: ["2BZqI-RYIEo"]
  },
  {
    ...
    tier: "full",
    awards: [
      "[trophy]Runner-Up — Heritage Gameathon 2026, Abu Dhabi"
    ],
    links: [
    ...
    description: {
      ...
      notable: "[trophy]Runner-Up, Heritage Gameathon 2026, Abu Dhabi, 22 entries total"
    },
    youtube: ["O4yQtrsOCUs"]
  },
  {
    ...
    tier: "full",
    awards: [
      "[trophy]Best Studio Project — SAE Institute 2021"
    ],
    links: [
    ...
    description: {
      ...
      contributions: "Part of a larger team, responsible for a substantial portion of the codebase.\n\nBuilt the full enemy AI system covering multiple distinct enemy types including ranged, melee, grenade-throwing, and drone-spawning variants, each with their own behaviour and attack patterns. Implemented the grenade system with a cooking mechanic and visible trajectory preview.\n\nBuilt the networked multiplayer layer using Photon, including player spawning, enemy synchronisation across clients, and networked death.\n\nDeveloped the tarot card roguelite modifier selection system, the loot and chest system with upgrade shop, and a fully rebindable input manager with save and load.\n\nAlso handled level 2 design and population, UI work, and audio integration throughout.",
      notable: "[trophy]Best Studio Project, SAE Institute Dubai 2021"
    },
    youtube: ["FZi3oIOzDKk"]
  },
  {
    ...
    description: {
      ...
      contributions: "One of three programmers on the project. Worked on top of a custom networking layer built by a teammate to design and implement all puzzle systems, making each one functional over multiplayer.\n\nBuilt four networked puzzles: a map jigsaw puzzle, a replicate puzzle, a radio tuning puzzle, and a Morse code puzzle — each requiring state to be synchronised correctly across all connected clients.\n\nAlso handled character selection over the network, the settings menu, and end game screens.",
      notable: "[star]University project, SAE Institute Dubai"
    },
    youtube: ["Oq2eE_yoWps"]
  },
  {
    ...
    description: {
      ...
      contributions: "One of two programmers on the project.\n\nBuilt the player movement system including slide, crouch, and a double jump jetpack mechanic.\n\nImplemented the full dialogue system across all four levels, handled all level decoration, lighting, and post-processing, and integrated all audio including ambient sounds, movement audio, and voiced dialogue.\n\nBuilt the animated main menu system.",
      notable: "[star]University project, SAE Institute Dubai"
    },
    youtube: ["El3w6VNfu4Q"]
  },
  {
    ...
    description: {
      ...
      contributions: "Small team built over 48 hours.\n\nBuilt the player movement system with a dash ability and cooldown, and the perk and ability loss system with swap UI and icons forming the core game mechanic.\n\nBuilt the dialogue system with voice overs across all levels, level complete flow with fades, and the main menu.\n\nHandled all audio and VFX throughout.",
      notable: "[star]Global Game Jam 2021"
    },
    youtube: ["mFtMzJf2tGs"]
  },
  {
    ...
    description: {
      ...
      contributions: "One of the programmers on a large collaborative team.\n\nBuilt the camera system, the full shooting system with tracer bullets, muzzle flash, and hit markers, and AI for multiple enemy types including knights and archers with separation and alignment behaviours.\n\nBuilt a wave system with burst wave support, ammo UI, health bars with gradient visuals, a wall health bar, and custom Unity editor tools for level setup.\n\nBuilt VFX for enemy attacks, a cutscene system with skippable sequences, win and loss screens, and the main menu with animated buttons and hover particle effects. Also handled audio integration throughout.",
      notable: "[star]University project, SAE Institute Dubai, collaboration across games, animation, graphic design, and audio departments"
    },
  ...
  },
  {
    ...
    description: {
      ...
      contributions: "Lead programmer on a small team that started with two programmers, a designer, and animation student collaborators, eventually carrying the codebase solo after the other programmer left mid-project.\n\nBuilt the hex grid system with pathfinding, a GOAP AI system for enemy behaviour, a full turn-based battle manager, and multiple character classes with distinct skills.\n\nBuilt a party selection and recruitment system, an overworld with click-to-move navigation, a camera system using Bezier curves, a minimap, and a story and dialogue trigger system.\n\nBuilt cutscenes, a full menu system with transitions, and all UI throughout including profile cards, skill displays, and victory and loss screens.",
      notable: "[star]University project, SAE Institute Dubai"
    },
